...
#let SpecimenPage(font: (font: "Libertinus Serif"), body) = page[
  #set text(..font, size: 10pt, fallback: false)
...
#let SpecimenText-German = [
  #set text(lang: "de")
  #smallcaps[Deutsch:]
  Einst stritten sich Nordwind und Sonne, wer von ihnen beiden wohl der Stärkere wäre, als ein Wanderer, der in einen warmen Mantel gehüllt war, des Weges daherkam. Sie wurden einig, daß derjenige für den Stärkeren gelten sollte, der den Wanderer zwingen würde, seinen Mantel abzunehmen. Der Nordwind blies mit aller Macht, aber je mehr er blies, desto fester hüllte sich der Wanderer in seinen Mantel ein. _Endlich gab der Nordwind den Kampf auf. Nun erwärmte die Sonne die Luft mit ihren freundlichen Strahlen, und schon nach wenigen Augenblicken zog der Wanderer seinen Mantel aus._ Da mußte der Nordwind zugeben, daß die Sonne von ihnen beiden der Stärkere war.

  // JIPA German
  // https://www.cambridge.org/core/services/aop-cambridge-core/content/view/D74393072AA2D66032B8A6E58BE15082/S0025100300004084a.pdf/german.pdf
]
...
// NOTE - This is not a North Wind and the Sun text
